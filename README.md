# Antilatency SDK for Unreal Engine 3.5.0

Git command to clone this subset: `git clone --branch subset-bc1c013d7eb387594074697d86518dd77168c01d --single-branch https://github.com/AntilatencySDK/Release_3.5.0.git AntilatencySDK`
