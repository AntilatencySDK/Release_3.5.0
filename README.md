...
Git command to clone this subset: `git clone --branch subset-3b435730417c4a6eedc5dc74a6ff9505c396d9cd --single-branch https://github.com/AntilatencySDK/Release_3.5.0.git AntilatencySDK`
